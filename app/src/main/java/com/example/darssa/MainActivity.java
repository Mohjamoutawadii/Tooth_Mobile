...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnSelectImage = findViewById(R.id.pickImageButton);
        Button btnCaptureImage = findViewById(R.id.captureImageButton);
        imageView = findViewById(R.id.imageView);
        anglesTextView=findViewById(R.id.left);
                    ...
                    if (!isOnContour) {
                        ...
                        if (closestContourPoint != null && selectedPoints.size() < MAX_SELECTED_POINTS) {
                            ...
                            if (selectedPoints.size() == MAX_SELECTED_POINTS) {
                                ...
                                Toast.makeText(MainActivity.this, "4 points sélectionnés", Toast.LENGTH_SHORT).show();
                            }
                            processImage(originalBitmap);
                        }
                    } else {
...
// Calcul de l'angle de convergence
            double angleConvergence = 180 - ((90 -angleGauche )+ (90- angleDroit));


// Affichage des angles dans le TextView
            anglesTextView.setText("Angles Externes : \n");
            anglesTextView.append("Lingual a 15 de l'horizontal : " + angleGauche + " degrés\n");
            anglesTextView.append("Vestibulaire a 45 de l'horizontal : " + angleDroit + " degrés\n");
            anglesTextView.append("Angle de convergence : " + angleConvergence + " degrés\n");
            anglesTextView.append("Angles Internes : \n");
            anglesTextView.append("Lingual a 15 de l'horizontal : " + taperAngleDeg + " degrés\n");
            anglesTextView.append("Vestibulaire a 45 de l'horizontal : " + taperAngleDeg2 + " degrés\n");

            // Dessiner les deux droites horizontales
            Imgproc.line(contoursImage, new Point(p1.x - extendLength, p1.y), new Point(p1.x + extendLength, p1.y), new Scalar(0, 0, 255), 2);

            Imgproc.line(contoursImage, new Point(p3.x - extendLength, p3.y), new Point(p3.x + extendLength, p3.y), new Scalar(0, 0, 255), 2);
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            jsonBody.put("resultat", anglesTextView.getText().toString());
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            Toast.makeText(MainActivity.this, "Tp soummis avec succes", Toast.LENGTH_SHORT).show();
                        }
                    },
                    new Response.ErrorListener() {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(MainActivity.this, "Erreur de soumission", Toast.LENGTH_SHORT).show();
                        }
                    }
            );
