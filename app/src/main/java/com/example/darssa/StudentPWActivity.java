                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                String remarque = !jsonObject.isNull("remarque") ? jsonObject.getString("remarque") : "pas de remarque";

                                // Vérifier si la clé "validation" existe
                                String validation = !jsonObject.isNull("validation") ? jsonObject.getString("validation") : "pas de validation";
                                    byte[] photoBytes = Base64.decode(jsonObject.getString("imageFront"), Base64.DEFAULT);
